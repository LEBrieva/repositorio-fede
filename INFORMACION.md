...
Qué hacemos:
 ...
 🔹 Optimizamos procesos internos con medición de impacto
 🔹 Diseñamos estructuras fiscales, contables y societarias eficientes
 🔹 Desarrollamos equipos de trabajo comprometidos y resilientes
 🔹 Acompañamos proyectos de transformación desde el liderazgo humano
En Business Case creemos que el verdadero cambio no solo se mide en números: también se mide en los equipos que prosperan, en las culturas que se sostienen y en los sistemas que siguen funcionando cuando el líder ya no está.
...
### Información de MKT
Logo
Si el fondo es celeste negro

El BC es naranja claro
y el Business Case es naranja pastel apagado

Si el fondo es naranja claro
...
Tener claridad sobre si tu negocio es rentable o no.
Tomar decisiones con base en los números reales.
Organizar sueldos, pagos, y tus responsabilidades como empleador.
 Detectar riesgos y oportunidades desde lo financiero y lo impositivo.

#### Servicios principales
Contable, impositivo y administración de personal
Contabilidad y Reporting: Armado de balances y reportes que se entienden.
Asesoramiento Impositivo: Planificación y presentación de declaraciones.
Gestión Preventiva: Proyectamos impuestos para evitar sorpresas.
...
Contamos con una red de contadores especializados en tributación para brindar un servicio técnico y actualizado, adaptado a las necesidades de cada empresa:

Carolina Bonomi (Socia de DM Consultores):
    Planificación fiscal y normativa impositiva.
Daniela Monteagudo (Fundadora DM Consultores): 
    Asesoramiento tributario para pymes de múltiples sectores.
Matías Denis (Socio DM Consultores): 
    Procesos contables, liquidación de sueldos y cumplimiento fiscal.


## LOGOS
### LOGOS BUSINESS CASE
`public/imagens/logos/logo-claro.png` y `public/imagens/logos/logo-oscuro.png`

### LOGO ALIADOS
`public/imagens/logos/logo-aliados.jpeg`